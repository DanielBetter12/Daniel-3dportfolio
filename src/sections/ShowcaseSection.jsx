            ...
            <div className="showcaselayout">
                ...
                <div className="first-project-wrapper" ref={project1Ref}>
                    ...
                    <div className="text-content">
                        ...
                        <p className="text-white-50 md:text-xl">Designed and implemented a clean, mobile-responsive UI using React.js and Tailwind CSS, optimized for performance and user experience. Utilized the WebCam API to capture user facial images securely, enabling personalized skincare insights without storing sensitive data.</p>
                    </div>
                </div>
